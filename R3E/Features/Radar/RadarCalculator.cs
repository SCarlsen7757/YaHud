...
namespace R3E.Features.Radar
{
    ...
    {
        public static double[,] RotationMatrixFromEuler(Data.Vector3<double> euler)
        {
            double x = -euler.X;
            double y = -euler.Y;
            double z = -euler.Z;
        ...
        public static Vector3 RotateVector<T>(double[,] matrix, Data.Vector3<T> vector) where T : struct, IConvertible
        {
        ...
        public static Data.Vector3<float> SubtractVector(Data.Vector3<float> a, Data.Vector3<float> b)
        {
            return new Data.Vector3<float>
            {
                X = a.X - b.X,
                Y = a.Y - b.Y,
                Z = a.Z - b.Z
